...
class assign_feedback_gradetracker extends assign_feedback_plugin {
    ...
    /**
     * Check if the gradetracker plugin is enabled
     * @return bool
     */
    ...
    /**
     * Can't do anything with Moodle 2.2 assignments
     * @param string $type
     * @param int $version
     * @return false
     */
    ...
    /**
     * Does not support quick grading.
     * @return false
     */
    ...
    /**
     * Save the feedback and update the gradetracker grids
     ...
     * @param stdClass $data
     * @param int $userid
     * @return bool True if elements were added to the page
     * @throws coding_exception
     */
    public function get_form_elements_for_user($grade, MoodleQuickForm $mform, stdClass $data, $userid) {
        ...
        if ($quals) {
            foreach ($quals as $qualID) {
                ...
                if (!$qual->getStudent()->isOnQual($qualID, "STUDENT")) {
                    continue;
                }
